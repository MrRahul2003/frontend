...
const FilterPurchaseOrder = ({AllPurchaseOrder, setAllPurchaseOrderFiltered}) => {
    const [search, setSearch] = useState({
      ...
      const filteringFunction = async () => {
        var filteredData = await AllPurchaseOrder.filter((item) =>
          item.uuid_id.includes(search.uuid_id.toLocaleLowerCase())
        );
        setAllPurchaseOrderFiltered(filteredData);
